...
export const todoSlice=createSlice({
    ...
    reducers:{
        addTodo:(state,action)=>{
            ...
            //acessing state directly is allowed  because previous state is preserved so no need to use the Spread Operator
        },
        // reducer 2
...
export const {addTodo,removeTodo,editTodo}=todoSlice.actions //we have to export each reducer indivisualy 
